...
public class FabricaEntidades {
    ...
    @SuppressWarnings("exports")
	public ContextoKoopaTroopa getContextoKoopaTroopa(Vector<Integer> posicion,Visitante visitor, int velocidad, 
    												  Vector<Integer> direccion, ObserverGrafico observerGrafico) {
