...
public class KoopaEnCaparazon implements EstadoKoopa {
	...
	public void actualizarHitboxYPosicion(FabricaSprites fabricaSprites) {
		...
		int y = this.getContext().obtenerPosicion().y + (this.getContext().obtenerAlto() - this.getContext().obtenerSprite().getAltoImagen());
		int ancho = this.getContext().obtenerSprite().getAnchoImagen();
		int alto = this.getContext().obtenerSprite().getAltoImagen();
