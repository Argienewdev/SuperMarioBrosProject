...
public class MarioSprites {
	...
	public ImageIcon getMarioQuieto2() {
		return marioQuieto2;
	}

	public ImageIcon getMarioCaminando1() {
		return marioCaminando1;
	}

	public ImageIcon getMarioCaminando2() {
		return marioCaminando2;
	}

	public ImageIcon getMarioVolviendo1() {
		return marioVolviendo1;
	}

	public ImageIcon getMarioVolviendo2() {
		return marioVolviendo2;
	}

	public ImageIcon getMarioSaltando() {
		return marioSaltando;
	}

	public ImageIcon getMarioSaltando2() {
		return marioSaltando2;
	}
}
